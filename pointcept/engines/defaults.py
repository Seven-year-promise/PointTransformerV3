...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        "--config-file", default="configs/semantic_kitti/semseg-pt-v2m2-1-benchmark-submit.py", metavar="FILE", help="path to config file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--save_path", type=str, default="/home/HKCRC_perception/PC_gen/PointTransformerV3/exp/semantic_kitti/semseg-pt-v2m2-1-benchmark-submit/", 
        help="model path"
    )
    parser.add_argument(
...
def default_config_parser(file_path, save_path, options):
